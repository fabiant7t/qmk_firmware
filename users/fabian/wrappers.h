...
#define ____________________ADJUST_L1____________________ _______, QK_BOOT, QK_RBT,  _______, _______, _______
#define ____________________ADJUST_L2____________________ _______, AU_TOGG, MI_MOD,  AU_ON,   AU_OFF,  AG_NORM
#define ____________________ADJUST_L3____________________ _______, _______, _______, MU_ON,   MU_OFF,  MI_ON

#define ____________________ADJUST_R0____________________ _______, _______, _______, _______, _______, _______
#define ____________________ADJUST_R1____________________ _______, _______, _______, QK_RBT,  QK_BOOT, EE_CLR
...
#define ___________________GENERIC_L4____________________ KC_LCTL, MEH_GRV, KC_LGUI, KC_LALT, LOWER,   RGUISPC
#define ___________________GENERIC_R4____________________ RGUISPC, RAISE,   KC_RALT, KC_RGUI, UMLAUT,  KC_RCTL
