 ...
 * | Shift|      |      |      |      |      |      |      |      |      |      |   ,  |   .  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | F23  | GUI  | Alt  |Lower |Space |      |      |      |Space |Raise |AltGr | GUI  | F24  | Ctrl |
 * `--------------------------------------------------------------------------------------------------------'
 */
[_BASE] = {
  ...
  { KC_LCTL, KC_F23,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,  _______, _______, _______, KC_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_F24,  KC_RGUI }
},
/* QWERTY
 * ,--------------------------------------------------------------------------------------------------------.
 * |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
