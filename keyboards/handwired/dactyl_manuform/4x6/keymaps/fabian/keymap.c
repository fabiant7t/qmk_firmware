...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_wrapper(
        ___________________COLEMAK_L1____________________,               ___________________COLEMAK_R1____________________,
    ...
    [_NAVIG] = LAYOUT_wrapper(
        ____________________NAVIG_L1_____________________,               ____________________NAVIG_R1_____________________,
        ____________________NAVIG_L2_____________________,               ____________________NAVIG_R2_____________________,
        ____________________NAVIG_L3_____________________,               ____________________NAVIG_R3_____________________,
        ___________________GENERIC_L4____________________,               ___________________GENERIC_R4____________________,
                                         TC_L5_0, TC_L5_1,               TC_R5_0, TC_R5_1,
                                         TC_L6_0, TC_L6_1,               TC_R6_0, TC_R6_1
    )
